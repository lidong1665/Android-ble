...
public class BluetoothLeService extends Service {
	...
	public final static String ACTION_CD01NOTIDIED = "com.choicemmed.bledemo.ACTION_CD01NOTIDIED";
	public final static String ACTION_CD02NOTIDIED = "com.choicemmed.bledemo.ACTION_CD02NOTIDIED";
	public final static String ACTION_CD03NOTIDIED = "com.choicemmed.bledemo.ACTION_CD03NOTIDIED";
	public final static String ACTION_CD04NOTIDIED = "com.choicemmed.bledemo.ACTION_CD04NOTIDIED";
	...
	private void broadcastUpdate(final String action,
		...
		if (data != null && data.length > 0) {
			String dataString = DeviceScanActivity.bytes2HexString(data);
...
在Activity中增加bindService 建立连接，处理设备读取数据，通过Broadcast处理数据和更新UI
